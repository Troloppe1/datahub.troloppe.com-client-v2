...
@Component({
  ...
  imports: [
    TextButtonComponent,
    AgGridAngular,
    CreateAndDownloadExternalListingsBtnsComponent,
  ],
...
export class IndexComponent implements OnDestroy {
  ...
  ngOnInit() {
    ...
    this.els
      .apiGetPaginatedListings(paginatedListingParams)
      .pipe(takeUntil(this.destroy$))
      .subscribe((v) => {
  ...
  cacheData(
    paginatedListingParams: PaginatedListingsParams,
    data: any,
    totalRecords: number,
  ) {
    this.dataCache.set(JSON.stringify(paginatedListingParams), {
      data,
      totalRecords,
    });
  }
